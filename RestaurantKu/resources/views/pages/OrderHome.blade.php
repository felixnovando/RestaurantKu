        ...
        <div class="mt-5">
            ...
            <div id="carouselExampleFade" class="carousel slide " data-ride="carousel" >
                <div class="px-4 carousel-inner ">
                    ...
                    @endif
                        <div class="row ">
                            <a href="{{url('/OrderMenu',['restaurantId' => $restaurants[0+$i+$i+$i+$i]["restaurantId"]])}}" class="flex flex-col items-center justify-center p-1.5  rounded-xl h-80 col-3">
                            ...
                            <a href="{{url('/OrderMenu',['restaurantId' => $restaurants[1+$i+$i+$i+$i]["restaurantId"]])}}" class="flex flex-col items-center justify-center p-1.5  rounded-xl h-80 col-3">
                            ...
                            <a href="{{url('/OrderMenu',['restaurantId' => $restaurants[2+$i+$i+$i+$i]["restaurantId"]])}}" class="flex flex-col items-center justify-center p-1.5 rounded-xl h-80 col-3">
                            ...
                            <a href="{{url('/OrderMenu',['restaurantId' => $restaurants[3+$i+$i+$i+$i]["restaurantId"]])}}" class="flex flex-col items-center justify-center p-1.5  rounded-xl h-80 col-3">
